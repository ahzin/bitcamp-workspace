...
public class App {
  ...
  public static void main(String[] args) {
    ...
    loop:
      while(true) {
        ...
        switch(command.toLowerCase()) { //입력값을 소문자로 바꿔줌
          case "/member/add" :
            addMember();
            break;
          case "/member/list" :
  ...
  static String promptString(String input) {
    System.out.print(input);
    return keyInput.nextLine();
  }

  static int promptInt(String input) {
    return Integer.parseInt(promptString(input));
  }

  static Date promptDate(String input) {
    return Date.valueOf(promptString(input));
  }
  ...
  static void addTask() {
    ...
    tworker[tcount] = promptString("관리자");
    tcount++ ;
  }
