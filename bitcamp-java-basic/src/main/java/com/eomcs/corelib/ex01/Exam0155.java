...
public class Exam0155 {
  public static void main(String[] args) {
    ...
    System.out.println(k3.equals(k6)); // equals()의 비교 결과도 같다, true

    // 즉 k3와 k6는 서로 다른 인스턴스 이지만,
    // hashCode()의 리턴 값이 같고, equals()의 리턴 값이 true이기 때문에
    // 두 객체는 같은 key로 간주한다.
    // 그래서 k3로 저장된 값을 k6로 꺼낼 수 있다.
    System.out.println(map.get(k6)); //Student [name=유관순, age=17, working=true]
    ...
    String k7 = new String("Haha"); //"Haha"는 없는 객체 -> null
