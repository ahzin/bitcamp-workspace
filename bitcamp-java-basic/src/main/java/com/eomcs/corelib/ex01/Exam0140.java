...
public class Exam0140 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(Integer.toHexString(obj1.hashCode())); //a09ee92
    System.out.println(Integer.toHexString(obj2.hashCode())); //30f39991

    System.out.println(obj1); //com.eomcs.corelib.ex01.Exam0140$My@a09ee92
    System.out.println(obj2); //com.eomcs.corelib.ex01.Exam0140$My@30f39991
