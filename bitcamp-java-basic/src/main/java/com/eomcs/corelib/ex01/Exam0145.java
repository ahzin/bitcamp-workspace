...
public class Exam0145 {
  ...
  public static void main(String[] args) {
    ...
    // 같은 해시코드를 리턴한다.
    System.out.println(s1.hashCode()); //-669750005
    System.out.println(s2.hashCode()); //-669750005
    System.out.println(s3.hashCode()); //-1142542181
    System.out.println(s4.hashCode()); //2004714183
