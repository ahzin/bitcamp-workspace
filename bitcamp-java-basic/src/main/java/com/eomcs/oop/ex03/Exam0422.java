...
public class Exam0422 {
  ...
  public static void main(String[] args) {
    ...
    //자동으로 호출될 생성자가 결정된다.
    new SmartPhone(); //SmartPhone() 생성자 호출됨!
    new SmartPhone(100); //SmartPhone(int) 생성자 호출됨!
    new SmartPhone("aaa",100); //SmartPhone(String, int) 생성자 호출됨!
    new SmartPhone(100,"aaa"); //SmartPhone(int, String) 생성자 호출됨!
