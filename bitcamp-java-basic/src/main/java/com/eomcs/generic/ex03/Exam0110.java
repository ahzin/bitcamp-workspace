...
public class Exam0110 {
  ...
  public static void main(String[] args) {
    ...
    //제너릭 타입의 어떠한 슈퍼클래스를 지정하지 않았기 때문에 어떤 타입이라도 가능하다.
    ArrayList<Manager> obj2 = new ArrayList<>(Member.class);
    ArrayList<Student> obj3 = new ArrayList<>(Student.class);
    ArrayList<Teacher> obj4 = new ArrayList<>(Teacher.class);
    ArrayList<Administrator> obj5 = new ArrayList<>(Administrator.class);
    ArrayList<String> obj6 = new ArrayList<>(String.class);
